...
export class BusketPresenter {
	...
	constructor(protected model: IBusketModel, protected viewPageContainer: IViewBusket, protected viewBusketProductConstructor: IViewBusketProductConstructor, protected modal: IPopup) {
	...
	renderView() {
		...
		this.viewPageContainer.busketSummary = this.model.getTotal()
